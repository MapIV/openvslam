...
landmark::landmark(const Vec3_t& pos_w, keyframe* ref_keyfrm, map_database* map_db)
    : id_(next_id_++), first_keyfrm_id_(ref_keyfrm->id_), last_observed_keyfrm_id_(ref_keyfrm->id_), pos_w_(pos_w),
...
landmark::landmark(const unsigned int id, const unsigned int first_keyfrm_id,
                   ...
                   map_database* map_db)
    : id_(id), first_keyfrm_id_(first_keyfrm_id), last_observed_keyfrm_id_(first_keyfrm_id), pos_w_(pos_w), ref_keyfrm_(ref_keyfrm),
